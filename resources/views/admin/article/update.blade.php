    ...
    <form class="layui-form" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text"  name="id"  value="{{$data->id}}" style="display: none;" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
                <input type="text"  name="name"  value="{{$data->title}}" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text"  name="keyword" value="{{$data->keyword}}" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
