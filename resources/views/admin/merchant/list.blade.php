...
<div class="x-body">
    <xblock>
        <button class="layui-btn" onclick="x_admin_show('创建商户','{{url('admin/merchant/create')}}@if(!empty($belongtoid))?belongto={{$belongtoid}}@else  @endif')"><i class="layui-icon"></i>创建商户</button>
    </xblock>
