...
<div class="x-body">
    <form class="layui-form" >
        ...
        <div class="layui-upload">
            <button type="button" class="layui-btn" id="test2">商户封面图上传</button>
            <input type="text"  name="img_url" value=""  id="avatar" style="display: none;" required="" lay-verify="required"
                   autocomplete="off" class="layui-input">
