...
<div class="x-body">
    <xblock>
        <button class="layui-btn" onclick="x_admin_show('创建案例类型数据','{{url('admin/case/type/data/create/'.$id)}}')"><i class="layui-icon"></i>创建案例类型数据</button>
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            ...
            $.ajax({
                ...
                url:"/admin/case/type/data/delete",
