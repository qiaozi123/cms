...
<div class="x-body">
    <xblock>
        <button class="layui-btn" onclick="x_admin_show('创建案例数据','{{url('admin/case/type/create')}}')"><i class="layui-icon"></i>创建案例数据</button>
    ...
    <table class="layui-table">
        ...
        @foreach($data as $key=>$item)
            <tr>
                ...
                <td>{{$item->id}}</td>
                <td>
                    <a title="查看案例分类数据"  style="color: red" onclick="x_admin_show('查看案例分类数据','/admin/case/type/data/list/{{$item->id}}')" href="javascript:;">
                        {{$item->name}}
                    </a>
                </td>
